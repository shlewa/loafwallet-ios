...
////    }
////
////    func getLFUserToken(ternioEndpoint: TernioUserEndpoint, registrationData: LitecoinCardAccountData
////    , completion: @escaping (String?) -> Void) { ///Need to CREATE A TOKEN
////
...
//    }
//
//    func createTernioUserAccount(completion: @escaping (Any?) -> Void) {
////
...
//     }
//
////    func createTernioWallet(ternioAccount: TernioAccountData) -> TernioUserTestnetWallet? {
